# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-11 20:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('armor_threshold', models.PositiveSmallIntegerField(default=0, verbose_name='absorption armure')),
                ...
                ('damage_threshold', models.PositiveSmallIntegerField(default=0, verbose_name='absorption dégâts')),
                ('damage_resistance', models.FloatField(default=0.0, verbose_name='résistance dégâts')),
                ('real_damage', models.PositiveSmallIntegerField(default=0, verbose_name='dégâts réels')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('threshold_modifier', models.FloatField(default=1.0, verbose_name="modif. d'absorption")),
                ...
                ('normal_threshold', models.PositiveSmallIntegerField(default=0, verbose_name='absorption normal')),
                ('normal_resistance', models.FloatField(default=0.0, verbose_name='résistance normal')),
                ('laser_threshold', models.PositiveSmallIntegerField(default=0, verbose_name='absorption laser')),
                ('laser_resistance', models.FloatField(default=0.0, verbose_name='résistance laser')),
                ('plasma_threshold', models.PositiveSmallIntegerField(default=0, verbose_name='absorption plasma')),
                ('plasma_resistance', models.FloatField(default=0.0, verbose_name='résistance plasma')),
                ('explosive_threshold', models.PositiveSmallIntegerField(default=0, verbose_name='absorption explosifs')),
                ('explosive_resistance', models.FloatField(default=0.0, verbose_name='résistance explosifs')),
                ('fire_threshold', models.PositiveSmallIntegerField(default=0, verbose_name='absorption feu')),
                ('fire_resistance', models.FloatField(default=0.0, verbose_name='résistance feu')),
                ('ammunitions', models.ManyToManyField(blank=True, related_name='weapons', to='fallout.Item', verbose_name='types de munitions')),
        ...
        migrations.AddField(
            model_name='fighthistory',
            name='damage',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fight', to='fallout.DamageHistory', verbose_name='historique des dégâts'),
        ),
        migrations.AddField(
            model_name='fighthistory',
            name='defender',
        ...
        migrations.AddField(
            ...
            name='armor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='fallout.Item', verbose_name='protection'),
        ),
        migrations.AddField(
            model_name='damagehistory',
            name='character',
