# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-04-02 18:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.CharField(choices=[('human', 'humain'), ('ghoul', 'ghoule'), ('super_mutant', 'super-mutant'), ('deathclaw', 'écorcheur'), ('robot', 'robot'), ('animal', 'animal')], default='human', max_length=12, verbose_name='race')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name='date de création')),
                ('modification_date', models.DateTimeField(auto_now=True, verbose_name='date de modification')),
                ('slot', models.CharField(blank=True, choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure'), ('implant', 'implant')], max_length=7, null=True, verbose_name='emplacement')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'historiques de combat',
            },
        ),
        migrations.CreateModel(
            name='Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='date')),
                ('game_date', models.DateTimeField(blank=True, null=True, verbose_name='date en jeu')),
                ('stats', models.CharField(blank=True, choices=[('S.P.E.C.I.A.L.', (('strength', 'force'), ('perception', 'perception'), ('endurance', 'endurance'), ('charisma', 'charisme'), ('intelligence', 'intelligence'), ('agility', 'agilité'), ('luck', 'chance'))), ('Compétences', (('small_guns', 'armes à feu légères'), ('big_guns', 'armes à feu lourdes'), ('energy_weapons', 'armes à énergie'), ('unarmed', 'à mains nues'), ('melee_weapons', 'armes de mélée'), ('throwing', 'armes de lancer'), ('first_aid', 'premiers secours'), ('doctor', 'médecine'), ('chems', 'chimie'), ('sneak', 'discrétion'), ('lockpick', 'crochetage'), ('steal', 'pickpocket'), ('traps', 'pièges'), ('science', 'science'), ('repair', 'réparation'), ('speech', 'discours'), ('barter', 'marchandage'), ('gambling', 'hasard'), ('survival', 'survie'), ('knowledge', 'connaissance')))], max_length=10, null=True, verbose_name='statistique')),
