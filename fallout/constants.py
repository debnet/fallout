...
RACES_STATS = {
    RACE_HUMAN: {
        ...
        SPECIAL_LUCK: (0, 1, 10),
        RESISTANCE_ELECTRICITY: (0.3, -1.0, 1.0),
    ...
    RACE_GHOUL: {
        ...
        SPECIAL_AGILITY: (0, 1, 10),
        SPECIAL_LUCK: (0, 5, 12),
        RESISTANCE_RADIATION: (0.8, -1.0, 1.0),
        RESISTANCE_POISON: (0.3, -1.0, 1.0),
    ...
    RACE_SUPER_MUTANT: {
        ...
        SPECIAL_LUCK: (0, 1, 10),
        STATS_DAMAGE_RESISTANCE: (0.25, -1.0, 1.0),
        RESISTANCE_RADIATION: (0.5, -1.0, 1.0),
        RESISTANCE_POISON: (0.2, -1.0, 1.0),
        RESISTANCE_FIRE: (0.25, -1.0, 1.0),
    ...
    RACE_DEATHCLAW: {
        ...
        SPECIAL_LUCK: (0, 1, 10),
        STATS_DAMAGE_RESISTANCE: (0.4, -1.0, 1.0),
    ...
    RACE_ROBOT: {
        ...
        RESISTANCE_RADIATION: (1.0, -1.0, 1.0),
        RESISTANCE_POISON: (1.0, -1.0, 1.0),
        RESISTANCE_FIRE: (0.4, -1.0, 1.0),
        RESISTANCE_ELECTRICITY: (-0.5, -1.0, 1.0),
        RESISTANCE_GAZ_CONTACT: (1.0, -1.0, 1.0),
        RESISTANCE_GAZ_INHALED: (1.0, -1.0, 1.0),
...
COMPUTED_STATS = (
    ...
    # Resistances
    ('radiation_resistance', lambda s, c: (2 * s.endurance) / 100),
    ('poison_resistance', lambda s, c: (5 * s.endurance) / 100),
    # Skills
