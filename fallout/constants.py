...
__all__ = (
    ...
    'RACES_STATS', 'RADS_EFFECTS', 'RANGED_CLOSE_MALUS_MULT', 'RANGED_MALUS_MULT', 'RANGED_LONG_MULT',
    'RANGE_MODIFIERS', 'RANGED_NORMAL_MULT', 'RANGED_SCOPED_MULT', 'SLEEP_EFFECTS', 'SPECIAL_POINTS',
