...
__all__ = (
    ...
    'ITEM_BOOK', 'ITEM_CHEM', 'ITEM_EXTRA', 'ITEM_FOOD', 'ITEM_GRENADE', 'ITEM_HELMET', 'ITEM_MISC', 'ITEM_TYPES',
    'ITEM_WEAPON', 'LABEL_CRITICAL', 'LABEL_FAIL', 'LABEL_SUCCESS', 'LEVELED_STATS', 'LIST_ALL_RESISTANCES',
    'LIST_ALL_STATS', 'LIST_BODY_PARTS', 'LIST_DAMAGES_TYPES', 'LIST_EDITABLE_STATS', 'LIST_FIGHT_STATUS',
    'LIST_GENERAL_STATS', 'LIST_HEALS', 'LIST_ITEM_TYPES', 'LIST_LEVELED_STATS', 'LIST_NEEDS', 'LIST_NON_DAMAGE',
    'LIST_PHYSICAL_DAMAGE', 'LIST_RACES', 'LIST_RESISTANCES', 'LIST_ROLL_STATS', 'LIST_SECONDARY_STATS', 'LIST_SKILLS',
    'LIST_SLOT_ITEM_TYPES', 'LIST_SPECIALS', 'LIST_THRESHOLDS', 'MODES', 'MODE_LONG', 'MODE_MELEE', 'MODE_RANGED',
    'MODE_SCOPED', 'MODE_THROW', 'PART_ARMS', 'PART_EYES', 'PART_HEAD', 'PART_LEGS', 'PART_TORSO', 'PERK_RATE',
    'RACES', 'RACE_ANIMAL', 'RACE_CREATURE', 'RACE_DEATHCLAW', 'RACE_GHOUL', 'RACE_HUMAN', 'RACE_ROBOT',
    'RACE_SUPER_MUTANT', 'RADS_LABELS', 'RESISTANCES', 'RESISTANCE_DAMAGE', 'RESISTANCE_ELECTRICITY',
    'RESISTANCE_EXPLOSIVE', 'RESISTANCE_FIRE', 'RESISTANCE_GAZ_CONTACT', 'RESISTANCE_GAZ_INHALED', 'RESISTANCE_LASER',
    'RESISTANCE_NORMAL', 'RESISTANCE_PLASMA', 'RESISTANCE_POISON', 'RESISTANCE_RADIATION', 'ROLL_STATS',
    'SECONDARY_STATS', 'SKILLS', 'SKILL_BARTER', 'SKILL_BIG_GUNS', 'SKILL_CHEMS', 'SKILL_DOCTOR',
    'SKILL_ENERGY_WEAPONS', 'SKILL_EXPLOSIVES', 'SKILL_FIRST_AID', 'SKILL_KNOWLEDGE', 'SKILL_LOCKPICK',
