...
class DamageInputSerializer(BaseCustomSerializer):
    ...
    threshold_modifier = serializers.IntegerField(default=0, initial=0, label=_("modificateur d'absorption"))
    threshold_rate_modifier = serializers.FloatField(default=0.0, initial=0, label=_("modificateur de taux d'absorption"))
    resistance_modifier = serializers.FloatField(default=0.0, initial=0.0, label=_("modificateur de résistance"))
