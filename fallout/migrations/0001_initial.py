# Generated by Django 2.1.7 on 2019-02-18 10:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normal_resistance', models.SmallIntegerField(default=0, verbose_name='résistance normal')),
                ('laser_threshold', models.SmallIntegerField(default=0, verbose_name='absorption laser')),
                ('laser_resistance', models.SmallIntegerField(default=0, verbose_name='résistance laser')),
                ('plasma_threshold', models.SmallIntegerField(default=0, verbose_name='absorption plasma')),
                ('plasma_resistance', models.SmallIntegerField(default=0, verbose_name='résistance plasma')),
                ('explosive_threshold', models.SmallIntegerField(default=0, verbose_name='absorption explosifs')),
                ('explosive_resistance', models.SmallIntegerField(default=0, verbose_name='résistance explosifs')),
                ('fire_threshold', models.SmallIntegerField(default=0, verbose_name='absorption feu')),
                ('fire_resistance', models.SmallIntegerField(default=0, verbose_name='résistance feu')),
                ('electricity_threshold', models.SmallIntegerField(default=0, verbose_name='absorption électricité')),
                ('electricity_resistance', models.SmallIntegerField(default=0, verbose_name='résistance électricité')),
                ('poison_threshold', models.SmallIntegerField(default=0, verbose_name='absorption poison')),
                ('poison_resistance', models.SmallIntegerField(default=0, verbose_name='résistance poison')),
                ('radiation_threshold', models.SmallIntegerField(default=0, verbose_name='absorption radiations')),
                ('radiation_resistance', models.SmallIntegerField(default=0, verbose_name='résistance radiations')),
                ('gas_contact_threshold', models.SmallIntegerField(default=0, verbose_name='absorption gaz (contact)')),
                ('gas_contact_resistance', models.SmallIntegerField(default=0, verbose_name='résistance gaz (contact)')),
                ('gas_inhaled_threshold', models.SmallIntegerField(default=0, verbose_name='absorption gaz (inhalé)')),
                ('gas_inhaled_resistance', models.SmallIntegerField(default=0, verbose_name='résistance gaz (inhalé)')),
                ...
                ('armor_class', models.SmallIntegerField(default=0, verbose_name="classe d'armure")),
                ('carry_weight', models.SmallIntegerField(default=0, verbose_name='charge maximale')),
                ('melee_damage', models.SmallIntegerField(default=0, verbose_name='dégâts en mêlée')),
                ...
                ('ap_cost_modifier', models.SmallIntegerField(default=0, verbose_name="modificateur d'action")),
                ('one_hand_accuracy', models.SmallIntegerField(default=0, verbose_name='précision à une main')),
                ('two_hands_accuracy', models.SmallIntegerField(default=0, verbose_name='précision à deux mains')),
                ...
                ('critical_raw_chance', models.SmallIntegerField(default=0, verbose_name='chances de dégâts bruts')),
                ('critical_damage', models.SmallIntegerField(default=0, verbose_name='modificateur dégâts critiques')),
                ...
                ('melee_weapons', models.SmallIntegerField(default=0, verbose_name='armes de mêlée')),
                ...
                ('thumbnail', models.CharField(blank=True, max_length=100, choices=[], verbose_name='miniature')),
                ('race', models.CharField(choices=[('human', 'humain'), ('ghoul', 'ghoule'), ('super_mutant', 'super-mutant'), ('deathclaw', 'écorcheur'), ('robot', 'robot'), ('animal', 'animal'), ('creature', 'créature')], db_index=True, default='human', max_length=20, verbose_name='race')),
                ...
                ('has_stats', models.BooleanField(default=False, verbose_name='stats calculées ?')),
                ('has_needs', models.BooleanField(default=False, verbose_name='besoins activés ?')),
                ...
                ('reward', models.PositiveSmallIntegerField(default=0, verbose_name='récompense')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('damage_type', models.CharField(blank=True, choices=[('normal', 'dégâts normaux'), ('laser', 'dégâts de laser'), ('plasma', 'dégâts de plasma'), ('explosive', 'dégâts explosifs'), ('fire', 'dégâts de feu'), ('electricity', "dégâts d'électricité"), ('poison', 'dégâts de poison'), ('radiation', 'dégâts de radiations'), ('gas_contact', 'dégâts de gaz (contact)'), ('gas_inhaled', 'dégâts de gaz (inhalé)'), ('raw', 'dégâts directs'), ('heal', 'soins de santé'), ('heal_rad', 'soins de radiations'), ('thirst', 'altérations de soif'), ('hunger', 'altérations de faim'), ('sleep', 'altérations de sommeil')], max_length=20, verbose_name='type de dégâts')),
                ...
                ('armor_damage', models.FloatField(default=0.0, verbose_name='dégâts armure')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.CharField(blank=True, max_length=100, choices=[], verbose_name='miniature')),
                ('chance', models.PositiveSmallIntegerField(default=100, verbose_name="chance d'effet")),
                ('duration', models.DurationField(blank=True, null=True, verbose_name="durée d'effet")),
                ('apply', models.BooleanField(default=True, verbose_name='appliquer ?')),
                ('interval', models.DurationField(blank=True, null=True, verbose_name='intervalle')),
                ('damage_chance', models.PositiveSmallIntegerField(default=100, verbose_name='chance de dégâts')),
                ('cancel_effect', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='fallout.Effect', verbose_name='effet annulé')),
                ...
                ('next_effect', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='fallout.Effect', verbose_name='effet suivant')),
            ],
            options={
                'verbose_name': 'effet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stats', models.CharField(choices=[('S.P.E.C.I.A.L.', (('strength', 'force'), ('perception', 'perception'), ('endurance', 'endurance'), ('charisma', 'charisme'), ('intelligence', 'intelligence'), ('agility', 'agilité'), ('luck', 'chance'))), ('Compétences', (('small_guns', 'armes à feu légères'), ('big_guns', 'armes à feu lourdes'), ('energy_weapons', 'armes à énergie'), ('unarmed', 'à mains nues'), ('melee_weapons', 'armes de mêlée'), ('throwing', 'armes de lancer'), ('first_aid', 'premiers secours'), ('doctor', 'médecine'), ('chems', 'chimie'), ('sneak', 'discrétion'), ('lockpick', 'crochetage'), ('steal', 'pickpocket'), ('traps', 'pièges'), ('explosives', 'explosifs'), ('science', 'science'), ('repair', 'réparation'), ('speech', 'discours'), ('barter', 'marchandage'), ('survival', 'survie'), ('knowledge', 'connaissance'))), ('Statistiques secondaires', (('max_health', 'santé maximale'), ('max_action_points', "points d'action max."), ('carry_weight', 'charge maximale'), ('armor_class', "classe d'armure"), ('melee_damage', 'dégâts en mêlée'), ('sequence', 'initiative'), ('healing_rate', 'taux de regénération'), ('ap_cost_modifier', "modificateur d'action"), ('one_hand_accuracy', 'précision à une main'), ('two_hands_accuracy', 'précision à deux mains'), ('damage_modifier', 'modificateur de dégâts'), ('critical_chance', 'chance de critique'), ('critical_raw_chance', 'chance de dégâts bruts'), ('critical_damage', 'modificateur dégâts critiques'))), ('Statistiques de niveau', (('hit_points_per_level', 'santé par niveau'), ('skill_points_per_level', 'compétences par niveau'), ('perk_rate', 'niveaux pour un talent'))), ('Résistances', (('damage_threshold', 'absorption de dégâts'), ('damage_resistance', 'résistance aux dégâts'), ('normal_threshold', 'absorption physique'), ('normal_resistance', 'résistance physique'), ('laser_threshold', 'absorption des lasers'), ('laser_resistance', 'résistance aux lasers'), ('plasma_threshold', 'absorption du plasma'), ('plasma_resistance', 'résistance au plasma'), ('explosive_threshold', 'absorption des explosions'), ('explosive_resistance', 'résistance aux explosions'), ('fire_threshold', 'absorption du feu'), ('fire_resistance', 'résistance au feu'), ('electricity_threshold', "absorption de l'électricité"), ('electricity_resistance', "résistance à l'électricité"), ('poison_threshold', 'absorption des poisons'), ('poison_resistance', 'résistance aux poisons'), ('radiation_threshold', 'absorption des radiations'), ('radiation_resistance', 'résistance aux radiations'), ('gas_contact_threshold', 'absorption du gaz (contact)'), ('gas_contact_resistance', 'résistance au gaz (contact)'), ('gas_inhaled_threshold', 'absorption du gaz (inhalé)'), ('gas_inhaled_resistance', 'résistance au gaz (inhalé)'))), ('Etat général', (('health', 'santé'), ('action_points', "points d'action"), ('thirst', 'soif'), ('hunger', 'faim'), ('sleep', 'sommeil'), ('rads', 'rads'), ('experience', 'expérience'), ('skill_points', 'points de compétence'), ('perk_points', 'points de talent'), ('karma', 'karma'), ('reward', 'récompense')))], max_length=30, verbose_name='statistique')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('hit_succeed', 'cible touchée'), ('hit_failed', 'cible manquée'), ('not_enough_ap', "points d'action insuffisants"), ('no_more_ammo', 'munitions insuffisantes'), ('target_dead', 'cible inconsciente'), ('target_killed', 'cible tuée'), ('weapon_broken', 'arme défectueuse')], max_length=20, verbose_name='status')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.CharField(blank=True, max_length=100, choices=[], verbose_name='miniature')),
                ('type', models.CharField(choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure'), ('helmet', 'casque'), ('grenade', 'grenade'), ('extra', 'accessoire'), ('tool', 'outil'), ('food', 'nourriture'), ('chem', 'drogue'), ('book', 'livre'), ('misc', 'autre')], max_length=10, verbose_name='type')),
                ...
                ('is_droppable', models.BooleanField(default=True, verbose_name='jetable ?')),
                ('hands', models.PositiveSmallIntegerField(choices=[(0, 'aucune'), (1, 'une main'), (2, 'deux mains')], default=0, verbose_name='mains nécessaires')),
                ('attack_mode', models.CharField(blank=True, choices=[('ranged', 'attaque à distance'), ('long', 'attaque à longue distance'), ('scoped', 'attaque avec lunette'), ('melee', 'attaque en mêlée'), ('throw', 'attaque de lancer')], max_length=20, verbose_name="mode d'attaque")),
                ('skill', models.CharField(blank=True, choices=[('small_guns', 'armes à feu légères'), ('big_guns', 'armes à feu lourdes'), ('energy_weapons', 'armes à énergie'), ('unarmed', 'à mains nues'), ('melee_weapons', 'armes de mêlée'), ('throwing', 'armes de lancer'), ('first_aid', 'premiers secours'), ('doctor', 'médecine'), ('chems', 'chimie'), ('sneak', 'discrétion'), ('lockpick', 'crochetage'), ('steal', 'pickpocket'), ('traps', 'pièges'), ('explosives', 'explosifs'), ('science', 'science'), ('repair', 'réparation'), ('speech', 'discours'), ('barter', 'marchandage'), ('survival', 'survie'), ('knowledge', 'connaissance')], max_length=20, verbose_name='compétence')),
                ...
                ('min_range', models.PositiveSmallIntegerField(default=0, verbose_name='portée minimale')),
                ('max_range', models.PositiveSmallIntegerField(default=0, verbose_name='portée maximale')),
                ('min_burst_range', models.PositiveIntegerField(default=0, verbose_name='portée min. en rafale')),
                ('max_burst_range', models.PositiveIntegerField(default=0, verbose_name='portée max. en rafale')),
                ('hit_chance_modifier', models.SmallIntegerField(default=0, verbose_name='modificateur de précision')),
                ('armor_class_modifier', models.SmallIntegerField(default=0, verbose_name="modificateur classe d'armure")),
                ('threshold_modifier', models.SmallIntegerField(default=0, verbose_name="modificateur d'absorption")),
                ('threshold_rate_modifier', models.SmallIntegerField(default=0, verbose_name="modificateur taux d'absorption")),
                ...
                ('damage_modifier', models.SmallIntegerField(default=0, verbose_name='modificateur de dégâts')),
                ('critical_modifier', models.SmallIntegerField(default=0, verbose_name='chances de critiques')),
                ('critical_raw_modifier', models.SmallIntegerField(default=0, verbose_name='chances de dégâts bruts')),
                ('critical_damage', models.SmallIntegerField(default=0, verbose_name='dégâts critiques')),
                ('critical_damage_modifier', models.SmallIntegerField(default=0, verbose_name='modificateur dégâts critiques')),
                ('armor_class', models.SmallIntegerField(default=0, verbose_name="classe d'armure")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_condition', models.PositiveSmallIntegerField(default=100, verbose_name='état min.')),
                ('max_condition', models.PositiveSmallIntegerField(default=100, verbose_name='état max.')),
