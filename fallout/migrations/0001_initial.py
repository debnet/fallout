# Generated by Django 2.1 on 2018-08-22 16:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slot', models.CharField(blank=True, choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure'), ('helmet', 'casque')], max_length=10, verbose_name='emplacement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.CharField(blank=True, max_length=100, verbose_name='miniature')),
                ('type', models.CharField(choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure'), ('helmet', 'casque'), ('food', 'nourriture'), ('chem', 'médicament'), ('misc', 'autre')], max_length=10, verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='date')),
                ('game_date', models.DateTimeField(blank=True, null=True, verbose_name='date en jeu')),
                ('stats', models.CharField(blank=True, choices=[('S.P.E.C.I.A.L.', (('strength', 'force'), ('perception', 'perception'), ('endurance', 'endurance'), ('charisma', 'charisme'), ('intelligence', 'intelligence'), ('agility', 'agilité'), ('luck', 'chance'))), ('Compétences', (('small_guns', 'armes à feu légères'), ('big_guns', 'armes à feu lourdes'), ('energy_weapons', 'armes à énergie'), ('unarmed', 'à mains nues'), ('melee_weapons', 'armes de mélée'), ('throwing', 'armes de lancer'), ('first_aid', 'premiers secours'), ('doctor', 'médecine'), ('chems', 'chimie'), ('sneak', 'discrétion'), ('lockpick', 'crochetage'), ('steal', 'pickpocket'), ('traps', 'pièges'), ('science', 'science'), ('repair', 'réparation'), ('speech', 'discours'), ('barter', 'marchandage'), ('gambling', 'hasard'), ('survival', 'survie'), ('knowledge', 'connaissance')))], max_length=20, verbose_name='statistique')),
