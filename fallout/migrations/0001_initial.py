# Generated by Django 2.1.4 on 2018-12-27 02:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normal_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance normal')),
                ('laser_threshold', models.SmallIntegerField(default=0, verbose_name='absorption laser')),
                ('laser_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance laser')),
                ('plasma_threshold', models.SmallIntegerField(default=0, verbose_name='absorption plasma')),
                ('plasma_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance plasma')),
                ('explosive_threshold', models.SmallIntegerField(default=0, verbose_name='absorption explosifs')),
                ('explosive_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance explosifs')),
                ('fire_threshold', models.SmallIntegerField(default=0, verbose_name='absorption feu')),
                ('fire_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance feu')),
                ('electricity_threshold', models.SmallIntegerField(default=0, verbose_name='absorption électricité')),
                ('electricity_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance électricité')),
                ('poison_threshold', models.SmallIntegerField(default=0, verbose_name='absorption poison')),
                ('poison_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance poison')),
                ('radiation_threshold', models.SmallIntegerField(default=0, verbose_name='rabsorption radiations')),
                ('radiation_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance radiations')),
                ('gas_contact_threshold', models.SmallIntegerField(default=0, verbose_name='absorption gaz (contact)')),
                ('gas_contact_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance gaz (contact)')),
                ('gas_inhaled_threshold', models.SmallIntegerField(default=0, verbose_name='absorption gaz (inhalé)')),
                ('gas_inhaled_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance gaz (inhalé)')),
                ...
                ('one_hand_accuracy', models.SmallIntegerField(default=0.0, verbose_name='précision à une main')),
                ('two_hands_accuracy', models.SmallIntegerField(default=0.0, verbose_name='précision à deux mains')),
                ('damage_threshold', models.SmallIntegerField(default=0, verbose_name='absorption de dégâts')),
                ('damage_resistance', models.SmallIntegerField(default=0.0, verbose_name='résistance aux dégâts')),
                ('damage_modifier', models.SmallIntegerField(default=0.0, verbose_name='modificateur de dégâts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('damage_type', models.CharField(blank=True, choices=[('normal', 'dégâts normaux'), ('laser', 'dégâts de laser'), ('plasma', 'dégâts de plasma'), ('explosive', 'dégâts explosifs'), ('fire', 'dégâts de feu'), ('electricity', "dégâts d'électricité"), ('poison', 'dégâts de poison'), ('radiation', 'dégâts de radiations'), ('gas_contact', 'dégâts de gaz (contact)'), ('gas_inhaled', 'dégâts de gaz (inhalé)'), ('raw', 'dégâts directs'), ('heal', 'soins de santé'), ('heal_rad', 'soins de radiations'), ('thirst', 'altération de soif'), ('hunger', 'altération de faim'), ('sleep', 'altération de sommeil')], max_length=20, verbose_name='type de dégâts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apply', models.BooleanField(default=False, verbose_name='appliquer ?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('armor_class_modifier', models.FloatField(default=0.0, verbose_name="modif. d'esquive")),
                ...
                ('critical_damage', models.PositiveIntegerField(default=0, verbose_name='dégâts critiques')),
                ('critical_damage_modifier', models.FloatField(default=0.0, verbose_name='modif. dégâts critiques')),
                ('armor_class', models.SmallIntegerField(default=0, verbose_name='esquive')),
