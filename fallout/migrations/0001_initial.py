    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('electricity_resistance', models.FloatField(default=0.0, verbose_name='résistance électricité')),
                ('poison_threshold', models.SmallIntegerField(default=0, verbose_name='absorption poison')),
                ('poison_resistance', models.FloatField(default=0.0, verbose_name='résistance poison')),
                ('radiation_threshold', models.SmallIntegerField(default=0, verbose_name='rabsorption radiations')),
                ('radiation_resistance', models.FloatField(default=0.0, verbose_name='résistance radiations')),
                ('gas_contact_threshold', models.SmallIntegerField(default=0, verbose_name='absorption gaz (contact)')),
                ('gas_contact_resistance', models.FloatField(default=0.0, verbose_name='résistance gaz (contact)')),
                ('gas_inhaled_threshold', models.SmallIntegerField(default=0, verbose_name='absorption gaz (inhalé)')),
                ('gas_inhaled_resistance', models.FloatField(default=0.0, verbose_name='résistance gaz (inhalé)')),
                ...
                ('damage_modifier', models.FloatField(default=0.0, verbose_name='modificateur de dégâts')),
