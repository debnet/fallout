...
class Migration(migrations.Migration):
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("thirst", "altérations de soif"),
                            ("hunger", "altérations de faim"),
                            ("sleep", "altérations de sommeil"),
                        ],
                        max_length=20,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "effects",
                    models.ManyToManyField(
                        blank=True, related_name="_item_effects_+", to="fallout.Effect", verbose_name="effets"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="item",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="+", to="fallout.Item", verbose_name="objet"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="effect",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="+", to="fallout.Effect", verbose_name="effet"
            ),
        ),
        migrations.AddField(
