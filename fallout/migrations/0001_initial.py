# Generated by Django 2.0.5 on 2018-05-20 01:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(blank=True, null=True, verbose_name="date d'arrêt")),
                ('next_date', models.DateTimeField(blank=True, null=True, verbose_name='date suivante')),
                ('character', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='active_effects', to='fallout.Character', verbose_name='personnage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('armor_threshold', models.SmallIntegerField(default=0, verbose_name='absorption armure')),
                ...
                ('damage_threshold', models.SmallIntegerField(default=0, verbose_name='absorption dégâts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slot', models.CharField(blank=True, choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure')], max_length=6, verbose_name='emplacement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('hit_succeed', 'cible touchée'), ('hit_failed', 'cible manquée'), ('not_enough_ap', "points d'action insuffisants"), ('no_more_ammo', 'munitions insuffisantes'), ('target_dead', 'cible inconsciente'), ('target_killed', 'cible défaite'), ('weapon_broken', 'arme défectueuse')], max_length=15, verbose_name='status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.CharField(blank=True, max_length=100, verbose_name='miniature')),
                ('type', models.CharField(choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure'), ('food', 'nourriture'), ('chem', 'médicament'), ('misc', 'autre')], max_length=6, verbose_name='type')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, limit_choices_to={'type': 'weapon'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='fallout.Item', verbose_name="arme de l'attaquant"),
        ),
        migrations.AddField(
            model_name='fighthistory',
            name='damage',
            field=models.OneToOneField(blank=True, limit_choices_to={'fight__isnull': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fight', to='fallout.DamageHistory', verbose_name='historique des dégâts'),
        ),
        migrations.AddField(
            model_name='fighthistory',
            name='defender',
        ...
        migrations.AddField(
            model_name='fighthistory',
            name='defender_armor',
            field=models.ForeignKey(blank=True, limit_choices_to={'type': 'armor'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='fallout.Item', verbose_name='protection du défenseur'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='armor',
            field=models.ForeignKey(blank=True, limit_choices_to={'type': 'armor'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='fallout.Item', verbose_name='protection'),
        ),
        migrations.AddField(
            model_name='damagehistory',
            name='character',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='fallout.Character', verbose_name='personnage'),
        ),
        migrations.AddField(
