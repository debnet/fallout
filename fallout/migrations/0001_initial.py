# Generated by Django 2.0.5 on 2018-06-03 16:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, max_length=200, verbose_name='titre')),
                ('description', models.TextField(blank=True, verbose_name='description')),
                ('image', models.ImageField(blank=True, upload_to='characters', verbose_name='image')),
                ('thumbnail', models.CharField(blank=True, max_length=100, verbose_name='miniature')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, max_length=200, verbose_name='titre')),
                ('description', models.TextField(blank=True, verbose_name='description')),
                ('image', models.ImageField(blank=True, upload_to='effects', verbose_name='image')),
                ('thumbnail', models.CharField(blank=True, max_length=100, verbose_name='miniature')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slot', models.CharField(blank=True, choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure'), ('helmet', 'casque')], max_length=6, verbose_name='emplacement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.CharField(blank=True, max_length=100, verbose_name='miniature')),
                ('type', models.CharField(choices=[('weapon', 'arme'), ('ammo', 'munition'), ('armor', 'armure'), ('helmet', 'casque'), ('food', 'nourriture'), ('chem', 'médicament'), ('misc', 'autre')], max_length=6, verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, max_length=200, verbose_name='titre')),
                ('description', models.TextField(blank=True, verbose_name='description')),
                ('image', models.ImageField(blank=True, upload_to='loots', verbose_name='image')),
                ('thumbnail', models.CharField(blank=True, max_length=100, verbose_name='miniature')),
            ],
            options={
